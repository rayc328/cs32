...
int countIncludes(const string a1[], int n1, const string a2[], int n2)
{
    ...
    int count = countIncludes(a1 + 1, n1 - 1, a2 + 1, n2 - 1); 

    if (a1[0] == a2[0])
    {
        return count + countIncludes(a1 + 1, n1 - 1, a2, n2);
    }
    else
...
void order(string a[], int n)
{
    ...
    int firstNotLess = 0;
    int firstGreater = 0; 
    separate(a, n, a[n-1], firstNotLess, firstGreater); //what do I use as the separator 
